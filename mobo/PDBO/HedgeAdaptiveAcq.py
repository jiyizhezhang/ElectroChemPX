...
class HedgeAdaptive:
    ...
    def __init__(self):
        ...
        self.eta = 4.0  ## default value is 4.0
        self.gamma = 0.75
    ...
    def iterate(self, init_x, init_y, prob, solver, models, trans, batch_size, reference_point):
        ...
        for ss in range(self.portfolio_size):
            ...
            batch_indices, alphas = find_batch(self.batch_size, cheaps, self.x, diff_hvs, unnormal_y, self.reference_point, alphas, True)  # why use unnormal y here
    ...
    def update_reward(self):
        ...
        for qq in range(self.portfolio_size):
            ...
            print("new point", np.asarray([ests[qq]]))
            # print(np.asarray([ests[qq]])
            # print("new_hv", new_hv)
            # print("old_hv", hv_prev)
            print("hv_contribution", hv_contribution)
        ...
        self.disc_rewards = [self.gamma * self.disc_rewards[i] + new_rewards[i] for i in range(self.portfolio_size)] # discounted reward
    ...
    def chooseHedge(self):
        ...
        print("Probability: ", self.probabilities)
